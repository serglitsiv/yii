...
class TreeSearch extends Tree
{
    ...
    {
        return [
            [['id', 'root', 'lft', 'rgt', 'lvl', 'icon_type', 'active', 'selected', 'disabled', 'readonly', 'visible', 'collapsed', 'movable_u', 'movable_d', 'movable_l', 'movable_r', 'removable', 'removable_all', 'content_type'], 'integer'],
            [['name', 'icon'], 'safe'],
        ];
    }
